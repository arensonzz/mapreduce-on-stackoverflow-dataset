...
if __name__ == "__main__":
    ...
    questions.to_csv("jobs/data/QuestionsSmallPre.csv", header=True, index=False, na_rep='NA')
    answers.to_csv("jobs/data/AnswersSmallPre.csv", header=True, index=False, na_rep='NA', )
